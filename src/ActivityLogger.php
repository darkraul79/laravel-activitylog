...
use darkraul79\Activitylog\Exceptions\CouldNotLogActivity;
...
class ActivityLogger
{
	 ...
	 * @return null|mixed
	 */
	public function log($text, $userId = '', $type, $about, $date)
	{
		...
		//        }
		//        $activity->log($text, $userId, compact('ipAddress','type','about','date'));
		...
		$activity->edition = $this->properties['edition'];
		$activity->period = $this->properties['period'];
	 ...
	 * @param \Illuminate\Database\Eloquent\Model|int|string $modelOrId
	 *
	 * @throws \darkraul79\Activitylog\Exceptions\CouldNotLogActivity
	 *
